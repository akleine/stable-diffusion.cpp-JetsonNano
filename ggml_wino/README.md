# ABOUT:
This code was taken from https://github.com/JingXuuu/sdcpp for an experiment using the Winograd algorithm. 
Unfortunately this code never was merged into main part of the ggml lib (https://github.com/ggml-org/ggml). 
Also I could not manage to use this part as a submodule, thus here are included only a few needed files.
